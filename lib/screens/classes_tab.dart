// lib/screens/classes_tab.dart - Updated to support initial tab
...
class ClassesTabPage extends StatefulWidget {
  ...
  const ClassesTabPage({Key? key, this.initialTab = 0}) : super(key: key);

  @override
  _ClassesTabPageState createState() => _ClassesTabPageState();
}

class _ClassesTabPageState extends State<ClassesTabPage> with SingleTickerProviderStateMixin {
...
// Keep the original ClassesTab for compatibility
